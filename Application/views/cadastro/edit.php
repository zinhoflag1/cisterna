        ...
        <form action="cadastro/store" method="post" enctype="multipart/form-data" name="frm" id="frm">
            ...
            <div class="row p-2 border">
                ...
                <div class="col-12">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form form-control" id="valorReal" name="renda_total" oninput="formatarValor(this)" required value="<?= $data['cadastro']['renda_total'] ?>"><br>
                    </div>
            ...
            <div class="row p-2 border">
                ...
                <div class="col-12">
                    ...
                    <textarea id="observacoes" name="obs" rows="5" cols="50" maxlength="255" style="width: 100%;height: 60px; border: 1px solid #ccc;border-radius: 5px;">
                        <?= $data['cadastro']['obs'] ?>
                    </textarea><br><br>
                </div>
